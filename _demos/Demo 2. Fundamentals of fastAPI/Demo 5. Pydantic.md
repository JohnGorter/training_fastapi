...
Make sure to add Pydantic and Pydantic[[email]] packages to the project. 
...
uv run ./main.py
```
and explain the details of serialization and validation. 

### step 3. Invalid data handling
Copy the following code beneath the existing code in the ./main.py and show how Pydantic handles invalid data. 
...
uv run ./main.py
```
and explain the demo

### step 4. Demo complexer validation 

Replace the code in ./main.py with the code below and explain how this is a more elaborate example of validation where negative prices raise errors, just like the slide suggested
...
### step 5. Strictness demo

Replace the code with the code below and explain the example with strict=True.
...
### step 6. Nested models and lists

Replace the code with the code below and show how nested data structures deserialize and validate
```
...
### step 7. field decorator validator

Copy the code below into ./main.py. Walk through the code and show the result
...
### step 8. model validator decorator
Do the same (copy, explain run) for the following code
```
